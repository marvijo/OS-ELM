function [beta,TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = OSELM(TrainingData_File, TestingData_File, Elm_Type, w,nHiddenNeurons, ActivationFunction, N0, Block)
...
%eval('save debug1.mat P0 IW Bias H0')
...
for n = N0+1 : Block : nTrainingData
...
%eval('save debug1.mat BETA1 M1x')
